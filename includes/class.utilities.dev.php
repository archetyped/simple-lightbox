...
class SLB_Debug {
	...
	/**
	 * Retrieve unix timestamp to nearest microsecond
	 ...
	 * @param string (optional) $name Timer to start
	 * @param float (optional) $time Start time to set for timer (Default: now)
	 */
	...
	/**
	 * Stop a timer
	 * @param string (optional) $name Timer to stop
	 */
	 ...
	 * @param string (optional) $name Timer to retrieve
	 ...
	 * @param string (optional) $name Timer to retrieve
	 * @param string (optional) $format Output string format
	 */
	 ...
	 * @uses SLB_Debug::backtrace() to retrieve caller properties
