...
var Viewer = {
	...
	/* Images from permalink */

	images_uri_mode: function() {
		return this.get_attribute('images_from_permalink', true) ? 'permalink' : 'source';
	},
